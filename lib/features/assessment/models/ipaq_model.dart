...
class IPAQModel {
  ...
  /// `activity_level` is generated by Postgres, not written by the app — a
  /// questionnaire restored from Supabase recomputes it here, and it must
  /// classify identically to one filled in live.
  ...
  ///
  /// `activity_level` is a generated column: Postgres derives it and rejects
  /// any insert that supplies one, so saveIpaq omits it. It is recomputed here
  /// from the restored answers rather than read back, which keeps a row
  /// written before the column existed classifying the same as a fresh one.
